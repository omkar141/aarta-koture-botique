...
const { mockDatabase } = require('./mockUsers');
...
const initializeMockData = () => {
  mockDatabase.customers = mockCustomers;
  mockDatabase.orders = mockOrders;
  mockDatabase.payments = mockPayments;
  mockDatabase.inventory = mockInventory;
};
